...
mouse_check_first	be	mouse_light_4		mouse_button1		mouse_test_num1
			be	mouse_check_next	0	0
mouse_light_4		cp	0x80000002		mouse_test_num4
mouse_check_next	be	mouse_light_1		mouse_button2		mouse_test_num1
			be	mouse_check_last	0	0
mouse_light_1		cp	0x80000002		mouse_test_num2
mouse_check_last	be	mouse_light_2		mouse_button3		mouse_test_num1
			be	mouse_check_pos		0	0
mouse_light_2		cp	0x80000002		mouse_test_num1

mouse_check_pos		add	mouse_test_check_range	mouse_posx		mouse_deltax
			blt	mouse_test_minoutx	mouse_test_check_range	mouse_test_num0
			blt	mouse_test_maxoutx	mouse_test_xmax		mouse_test_check_range
			cp	mouse_posx		mouse_test_check_range
			be	mouse_checky		0	0
mouse_test_minoutx	cp	mouse_posx		mouse_test_num0
			be	mouse_checky		0	0
mouse_test_maxoutx	cp	mouse_posx		mouse_test_xmax

mouse_checky		add	mouse_test_check_range	mouse_posy		mouse_deltay
			blt	mouse_test_minouty	mouse_test_check_range	mouse_test_num0
			blt	mouse_test_maxouty	mouse_test_ymax		mouse_test_check_range
			cp	mouse_posy		mouse_test_check_range
			be	mouse_test_print	0	0
mouse_test_minouty	cp	mouse_posy		mouse_test_num0
			be	mouse_test_print	0	0
