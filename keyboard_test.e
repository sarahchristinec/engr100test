...
keyboard_new_char	cp	lcd_print_char		keyboard_ascii
			blt	ket_test_overflow	num_31			key_test_iterator
...
ket_test_first_row	cp	lcd_print_xloc		key_test_iterator
			cp	lcd_print_yloc		num_0
			be	key_test_iterate	0			0
key_test_next_row	cp	lcd_print_xloc		key_test_iterator	num_16
			cp	lcd_print_yloc		num_1

ket_test_iterate	add	key_test_iterator	key_test_iterator	num_1
