...
lcd_message_start	be	done		lcd_iterator		lcd_message_length
			...
			blt	lcd_set_row1	lcd_iterator	num_16
lcd_set_row2		cp	lcd_print_yloc	num_1
			be	lcd_set_column	0	0
lcd_set_row1		cp	lcd_print_yloc	num_0
lcd_set_column		cp 	lcd_print_xloc	lcd_iterator
			add	lcd_iterator	lcd_iterator	num_1		//iterate
